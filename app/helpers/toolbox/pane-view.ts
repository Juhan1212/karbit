import type { Coordinate, IPanePrimitivePaneView } from "lightweight-charts";
import { Drawing, type Point } from "./drawing";
import { DrawingPaneRenderer } from "./pane-renderer";
import { TwoPointDrawing } from "./two-point-drawing";

export abstract class DrawingPaneView implements IPanePrimitivePaneView {
  _source: Drawing;
...
export abstract class TwoPointDrawingPaneView extends DrawingPaneView {
  ...
  _getX(p: Point) {
    ...
    // ASIS : return timeScale.logicalToCoordinate(p.logical)
  }
}
